!(function(e, t) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? define("ElMultipleUpload", [
        "element-ui",
        "@panhezeng/utils/dist/check-upload.js",
        "@panhezeng/utils/dist/get-object-item-by-path.js"
      ], t)
    : "object" == typeof exports
    ? (exports.ElMultipleUpload = t(
        require("element-ui"),
        require("@panhezeng/utils/dist/check-upload.js"),
        require("@panhezeng/utils/dist/get-object-item-by-path.js")
      ))
    : (e.ElMultipleUpload = t(e.ELEMENT, e.checkUpload, e.getObjectItemByPath));
  ...
  return (function(e) {
    ...
    function(e, t, o) {
      "use strict";
      o.r(t),
        o.d(t, "ElMultipleUpload", function() {
          return i;
        });
      var n,
        i = o(4).default;
      function l(e) {
        var t =
          arguments.length > 1 && void 0 !== arguments[1]
            ? arguments[1]
            : "undefined" != typeof window && window.ElMultipleUploadOptions;
        n
          ? console.warn(
    ...
    function(e, t, o) {
      ...
      var i = o(0),
        ...
        u = o(2),
        a = o.n(u);
      var s = (function(e, t, o, n, i, l, r, u) {
        var a,
          s = "function" == typeof e ? e.options : e;
        if (
          (t && ((s.render = t), (s.staticRenderFns = o), (s._compiled = !0)),
          n && (s.functional = !0),
      ...
      })(
        {
          ...
          methods: {
            beforeUpload: function(e) {
              var t = r()(e, this.type, this.size);
              return this.checkUpload
                ? this.checkUpload(e, t)
                : (t.message && i.Message.error(t.message), t.validate);
            },
            requestUpload: function(e) {
              return this.upload(e);
            },
            successUpload: function(e, t, o) {
              var n = this;
              (this.elFileList = o),
                o.every(function(e) {
                  return !("ready" === e.status || "uploading" === e.status);
                }) &&
                  this.$emit(
                    "update:fileList",
                        ...
                        "success" === t.status &&
                          (t.response
                            ? e.push({
                                uid: t.uid,
                                name: t.name,
                                url: a()(t.response, n.resPathOfUrl, t.url)
                              })
                            : e.push(t)),
                        e
                      );
